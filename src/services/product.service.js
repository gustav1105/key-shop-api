...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        ...
        // Define your methods as per your .proto file
        ProductsService_1.prototype.getProductById = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Implement your logic here to fetch the product by ID
        ...
        ProductsService_1.prototype.listProducts = function (request) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Implement your logic here to list products based on the query
                    // This is a mock response for demonstration
                    return [2 /*return*/, {
                            products: [
    ...
    (function () {
        ...
        _getProductById_decorators = [(0, microservices_1.GrpcMethod)('ProductService', 'GetProductById')];
        _listProducts_decorators = [(0, microservices_1.GrpcMethod)('ProductService', 'ListProducts')];
