...
var ProductsController = function () {
    ...
    var ProductsController = _classThis = /** @class */ (function () {
        ...
        ProductsController_1.prototype.getProduct = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.productsService.getProductById({ id: id })];
                });
            });
        };
        ProductsController_1.prototype.listProducts = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.productsService.listProducts(query)];
                });
            });
        };
    ...
    (function () {
        ...
        _listProducts_decorators = [(0, common_1.Get)()];
